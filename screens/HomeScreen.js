...
const openCategory = (category) => {
  ...
  const servicesPreview = [
    { name: "Check-up", icon: "stethoscope-outline", color: "#C9F0FF" },
...
const styles = StyleSheet.create({
  ...
  announcementTitle: { fontSize: 16, fontWeight: "bold", marginBottom: 10 },
  announcementImages: { flexDirection: "row" },
  announcementImage: { width: 90, height: 90, marginHorizontal: 10 },
  sectionHeader: {
    flexDirection: "row",
    justifyContent: "space-between",
    marginHorizontal: 20,
  ...
  modalTitle: { fontSize: 18, fontWeight: "bold", color: "#00BFA6" },
...
categoryItem: { alignItems: "center", width: "22%", marginBottom: 10 },
categoryBox: {
  width: 60,
  height: 60,
  backgroundColor: "#E0F7F4",
